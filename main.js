...
const sections = document.querySelectorAll('section[testimonial]')
...
const scrollActive = () =>{
	...
	sections.forEach(current =>{
		const sectionHeight = current.offsetHeight,
			  ...
			  sectionsClass = document.querySelector('.nav__menu a[#home' + sectionId + ']')
